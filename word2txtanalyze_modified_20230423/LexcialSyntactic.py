...
dflist.append(masterdf)

output_filename = "LexicalSyntacticMasterData.xlsx"



if os.path.exists(output_filename):
    df_excelfile = pd.read_excel(output_filename)
...
acum_df_sorted["duplicate"] = acum_df_sorted.duplicated(subset=["ID", "RECN"], keep=False).astype(int)

acum_df_sorted.to_excel(output_filename, float_format='%.2f', index = False)
print('finished')
